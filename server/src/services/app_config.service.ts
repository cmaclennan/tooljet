...
export class AppConfigService {
  ...
  fetchDefaultConfig() {
    return [
      ...
      'SSO_OKTA_OAUTH2_CLIENT_ID',
      'SSO_OKTA_OAUTH2_CLIENT_SECRET',
      'SSO_OKTA_OAUTH2_DOMAIN',
      'SSO_OKTA_OAUTH2_REDIRECT_URI',
      'SSO_OKTA_OAUTH2_AUTH_SERVER',
      'SSO_OKTA_OAUTH2_ENABLE_SELF_HOSTED',
